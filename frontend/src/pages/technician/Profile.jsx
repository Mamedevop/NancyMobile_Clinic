        ...
        <div style={{ display: 'flex', flexDirection: 'column', gap: 20 }}>
          ...
          <div className="card">
            ...
            <form onSubmit={handleNameSave}>
              ...
              <div className="form-group">
                <label>{t('role')}</label>
                <input className="form-control" value={t('technician')} disabled style={{ background: '#f8f9fa', color: 'var(--gray)' }} />
              </div>
              <button className="btn btn-block" type="submit" disabled={saving}>
                <FaSave style={{ marginRight: 6 }} />{saving ? t('saving') : t('updateName')}
              </button>
            </form>
          </div>
